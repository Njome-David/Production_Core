          ...
          {!submitted ? (
            ...
            >
              ...
              <div className="text-center mb-10">
                ...
                <h1 className="text-4xl md:text-5xl font-display font-bold tracking-tighter text-foreground mb-4">
                  {t("demo_title")}
                </h1>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full h-12 px-4 rounded-xl bg-muted/50 border border-border text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500/50 transition-all text-sm"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full h-12 px-4 rounded-xl bg-muted/50 border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500/50 transition-all text-sm appearance-none cursor-pointer"
                    style={{
                  ...
                  >
                    <option value="" disabled className="bg-card">{t("demo_size_placeholder")}</option>
                    <option value="1" className="bg-card">{t("demo_size_1")}</option>
                    <option value="2" className="bg-card">{t("demo_size_2")}</option>
                    <option value="3" className="bg-card">{t("demo_size_3")}</option>
                    <option value="4" className="bg-card">{t("demo_size_4")}</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={3}
                    className="w-full px-4 py-3 rounded-xl bg-muted/50 border border-border text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500/50 transition-all text-sm resize-none"
            ...
            >
              ...
              <div className="max-w-sm mx-auto space-y-4 mb-12">
                <div className="flex items-center gap-4 p-4 rounded-xl bg-muted/50 border border-border text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/pricing">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="h-12 px-6 bg-muted text-foreground border border-border font-semibold rounded-full flex items-center gap-2 transition-all hover:bg-accent"
                  >
                    <ArrowLeft weight="bold" className="w-4 h-4" />
                    {t("pricing_title")}
                  </motion.button>
